...
public class ApiHelper {
     ...
     */
    public ValidatableResponse postUserDetails(String URL) throws IOException, JsonEOFException {
    ...
    public ValidatableResponse getRequest(String URL) throws IOException, DatabindException {
