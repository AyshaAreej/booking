...
public class London {
	...
	public void login() throws InterruptedException{
	 ...
	 Actions act = new Actions(driver);
		...
		WebElement ele = driver.findElement(By.xpath("//*[@id=\"xp__guests__inputs-container\"]/div/div/div[2]/div/div[2]/button[2]")); 
		act.doubleClick(ele).perform();
		Thread.sleep(3000);
	 
		Select drpCountry = new Select(driver.findElement(By.xpath("//*[@id=\"xp__guests__inputs-container\"]/div/div/div[3]/select[1]")));
		drpCountry.selectByVisibleText("2 years old");  
		
		Thread.sleep(3000);
		Select drpCountry1 = new Select(driver.findElement(By.xpath("//*[@id=\"xp__guests__inputs-container\"]/div/div/div[3]/select[2]")));
		drpCountry1.selectByVisibleText("6 years old");
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id=\"frm\"]/div[1]/div[4]/div[2]/button")).submit();
	Thread.sleep(3000);
	driver.findElement(By.xpath("//*[@id=\"searchboxInc\"]/div[1]/div/div/div[1]/div[5]/div[3]/label/div")).click();
